...
CREATE DATABASE IF NOT EXISTS `db_ealprinting` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_ealprinting`;
...
-- Dumping data for table db_ealprinting.tbl_category: ~1 rows (approximately)
...
-- Dumping data for table db_ealprinting.tbl_user: ~2 rows (approximately)
