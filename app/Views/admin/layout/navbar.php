        ...
        <ul class="navbar-nav navbar-align">
            ...
            <li class="nav-item dropdown">
                ...
                <?php
                    ...
                    $firstName = $session->get('first_name') ? $session->get('first_name') : 'User';
                ?>

                <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                    <img src="<?= base_url('assets/img/achie/EAL_LOGO.png') ?>" class="avatar img-fluid rounded me-1" alt="<?= $firstName ?>" /> 
